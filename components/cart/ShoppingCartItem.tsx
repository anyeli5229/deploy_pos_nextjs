    ...
    return (
        <li className="flex items-center space-x-6 py-6 relative">
            ...
            <div className="flex-auto space-y-2">
                ...
                >
                    {Array.from({length: item.inventory}, (_, index) => index + 1 ).map(num => (//Se genera las opciones del inventario en un arreglo, luegosi itera sobre ellas para mostrarlas en un select
