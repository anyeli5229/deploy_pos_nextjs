...
export default function Pagination({page, totalPages, baseUrl} : PaginationProps ) {
    ...
    const pages = Array.from({length: totalPages}, (_, i) => i + 1)//Genera un arreglo del tamaño de totalPages y como inicia en 0, se le suma un 1
  ...
  return (
    <nav className="flex justify-center py-10">
        {page > 1 && (
            <Link
                href={`${baseUrl}?page=${page - 1}`}//Regresa el valor cambiando la pagina
